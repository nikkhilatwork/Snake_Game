...
function gameEngine(){
    // part-1:update snake arr and food 
    ...
    // if u eaten food increment score and regenrte the food
...
// Main logic starts in here 

window.requestAnimationFrame(main);
window.addEventListener('keydown', e=>{
    iputDir = {x: 0, y: 1}   //start the game
    moveSound.play();
    switch(e.key) {
        case "ArrowUp":
            console.log("ArrowUp")
